...
// Transaction signature type from UMI
type TransactionSignature = Uint8Array | string;

export const confirmTransaction = async (
  umi: UmiInstance,
  signature: TransactionSignature,
  confirmOptions?: {
    strategy?: 'confirmed' | 'finalized' | 'processed';
    commitment?: 'confirmed' | 'finalized' | 'processed';
  }
) => {
  try {
    const confirmation = await umi.rpc.confirmTransaction(signature, {
      strategy: confirmOptions?.strategy || 'confirmed',
